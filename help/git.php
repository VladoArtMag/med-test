...
мержевание веток
1. сначало ветку master к ветке auch_moodle
находясь в ветке auch_moodle
2. Чаще всего при мержевании возникает конфликт ( одинаковые строки в одинаковых файлах были изменены), поэтому сначало подключаем прогу, с помощью которой будет разрешен конфликт
> git config --global merge.tool kdiff3
> git merge master

остальное на локалке